...
**This player is The 0riginal Adlib-Player-Engine for the Doofus game. After much effort, it was extracted from the game and made to run standalone from the command line.**
