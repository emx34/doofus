...
_________________________________________________________________________________________________________________________________________________________________________________
<br><br>
# ■ **Sprextga.exe --- Sprextga v1.0b First (alpha) version**
<br><br>
...
<br> 
  ...
  v1.0b: PKLite UNpacking process indicator-animation added
  <br><br>
...
# **(2)** - **STANDALONE ADLIB MUSIC PLAYER** <br> **"The Bone Shaker Architect" Engine --- TBSAplay.exe v0.4**
...
# **(4) DOOFUS GB-IMAGE-FILES(*_3f2.dat) to TGA Photoshop CONVERTER** <br> **--- GB2tga.exe v1.1**
