...
(3) DOOFUS GAME GB-IMAGE-FILES(*_3f2.dat) to TGA(TARGA)PHOTOSHOP  CONVERTER --- GB2tga.exe v1.0 / v2.0 has bidirectional conversion capability (forward and backward)
