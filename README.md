...
**This player is the original Adlib player engine for the Doofus game. After much effort, it was extracted from the game and made to run standalone in the MS-DOS command line.**
