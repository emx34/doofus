...
**This player, Doofus, is the game's own original adlib player engine. After much effort, it was extracted from the game and made to run standalone from the command line.**
